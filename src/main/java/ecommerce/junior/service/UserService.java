...
public class UserService {
    ...
    public void updateUser(User user, String senhaConfirmacao, User loggedInUser) throws Exception {
        ...
        System.out.println("Senha de confirmação fornecida: " + senhaConfirmacao);
        System.out.println("Senha do usuário logado: " + loggedInUser.getSenha());

        if (senhaConfirmacao != null && !senhaConfirmacao.isEmpty()) {
            // Verifique se a senha de confirmação está correta
        ...
        // Verifique o conteúdo do usuário antes de salvar
        System.out.println("Usuário a ser salvo: " + user);
